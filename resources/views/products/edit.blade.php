                ...
                <div class="card borde-0 shadow-1g my-5">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{old('sku',$product->sku)}}" type="text" class="form-control @error('sku') is-invalid @enderror 
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{old('price',$product->price)}}" type="text" class="form-control @error('price') is-invalid @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea  class="form-control
                             form-control-1g" cols="30" rows="5" placeholder="Description" name="description">{{old('description',$product->description)}}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for="image" class="form-label h4">Image</label>
                            <input value="{{old('image',$product->image)}}" type="file" class="form-control 
                             form-control-1g" placeholder="Image" name="image">
                             @if ($product->image!='')
                             <img class="mt-3" width="250" height="270" src="{{asset('uploads/products/'.$product->image)}}" alt="">
                         @endif
                        </div>
                        <div class="d-grid">
                            <button class="btn btn-lg bg-primary text-white text-center">Update</button>
                        </div>
                    </div>
                    </form>
                </div>
